        ...
        >
          ...
          <Box
            sx={{
              width: "18%",
              mt: 1,
              minWidth: "250px", // Keeps width consistent
              marginLeft: "20px", // Adds spacing
              position: "sticky", // Keeps it aligned
              top: "10vh", // Aligns with table header
              alignSelf: "start", // Ensures it follows the table header's height
            }}
          >
            <Typography
              sx={{
...
>>>>>>> 38aa78a408568d406ff36d1f31a3da436d47651d
      )}
    </div>
  );
};
